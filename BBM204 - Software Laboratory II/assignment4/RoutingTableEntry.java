...
public class RoutingTableEntry implements Serializable
{
    ...
    public boolean equals(Object o)
    {
        ...
        boolean sameCosts = ((totalRouteCost == Double.POSITIVE_INFINITY && entry.getTotalRouteCost() == Double.POSITIVE_INFINITY)
                || (Math.abs(entry.getTotalRouteCost() - totalRouteCost) <= 0.0001));
        return sameCosts && destinationIpAddr.equals(entry.getDestinationIpAddr()) && sourceIpAddr.equals(entry.getSourceIpAddr());
    }
